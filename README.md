...
A TypeScript CLI for browser-backed Microsoft Teams sessions. It supports multiple tenants and users, AWS-style profiles, and optional subject-path policies that can prevent messages from being sent to unintended chats or channels.
